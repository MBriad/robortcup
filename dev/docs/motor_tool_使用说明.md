...
# 直线标定:400 速度 1.0 秒的前进/后退实测距离(各测 3 次取均值)
python3 dev/motor_tool.py forward  --ground --speed 400 --duration 1.0
python3 dev/motor_tool.py backward --ground --speed 400 --duration 1.0
```
